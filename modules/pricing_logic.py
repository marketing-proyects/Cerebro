...
def mostrar_fijacion_precios():
    ...
    # 1. VISOR Y SELECCIÓN (Sin cambios, pero asegurando persistencia)
    ...
    # 2. ENTRADAS REACTIVAS (Aquí forzamos que el cambio dispare el resto)
    col_c, col_e = st.columns(2)
    with col_c:
        st.subheader("📦 Costo de Importación")
        # El cambio en estos inputs reinicia la ejecución de la función automáticamente
    ...
    # Re-calculamos todo en base a las variables de arriba (que ya cambiaron)
    ...
    # 4. ESTRATEGIA SUGERIDA (Se actualiza con el nuevo precio_neto)
    ...
    # 5. GRÁFICO (Se refresca con el nuevo precio_neto)
    if precios_ref:
    ...
    # 6. RESULTADOS FINALES (KPIs siempre al día)
    st.divider()
